...
export default function Home() {
  ...
  // Show sign-in prompt if not authenticated (no redirect)
  if (!session) {
    return (
      <main className="min-h-screen p-4 md:p-8 bg-background text-foreground">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="max-w-md mx-auto mt-8 p-6 bg-card border border-border rounded-lg">
            <h2 className="text-xl font-semibold mb-4 text-center">Authentication Required</h2>
            <p className="text-center text-muted-foreground mb-6">
              Please sign in to use the Bullet Builder application.
            </p>
